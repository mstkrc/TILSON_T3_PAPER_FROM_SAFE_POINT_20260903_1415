...
from ..components import display_button, field, kv_list, panel, table
...
def render_charts_screen(model=None) -> str:
    body = (
        '<div class="group2-panel-map group2-chart-map" data-panel-map="06_GRAFIKLER">'
        + '<div class="group2-chart-layout"><div class="group2-chart-left">'
        + _toolbar()
        + f'<div class="group2-chart-main">{_market_workspace()}</div>'
        + _bottom_panels()
