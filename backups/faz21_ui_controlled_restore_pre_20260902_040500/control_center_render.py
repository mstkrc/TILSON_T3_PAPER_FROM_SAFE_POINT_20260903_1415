...
def render_control_center(
    ...
    open_positions = [
        ("BTC/USDT", "LONG", "0.0321", "68,200.00", "68,302.54", "+102.54", "+1.82%", "2%", "ENTRY CFG"),
        ("ETH/USDT", "LONG", "0.2100", "2,576.10", "2,604.18", "+61.78", "+1.95%", "2%", "ENTRY CFG"),
        ("BNB/USDT", "LONG", "0.8400", "592.00", "596.20", "+18.32", "+0.88%", "2%", "ENTRY CFG"),
        ("SOL/USDT", "SHORT", "4.2500", "178.45", "175.84", "-27.61", "-1.61%", "2%", "ENTRY CFG"),
        ("ADA/USDT", "SHORT", "1.2500", "0.4985", "0.4951", "-8.64", "-0.63%", "2%", "ENTRY CFG"),
        ("MATIC/USDT", "LONG", "18.000", "0.4680", "0.4721", "+6.71", "+0.51%", "2%", "ENTRY CFG"),
        ("AVAX/USDT", "LONG", "0.920", "36.80", "37.21", "+7.12", "+0.55%", "2%", "ENTRY CFG"),
        ("LINK/USDT", "SHORT", "3.100", "14.95", "14.80", "+5.21", "+0.42%", "2%", "ENTRY CFG"),
        ("DOT/USDT", "LONG", "7.300", "6.19", "6.24", "+4.21", "+0.34%", "2%", "ENTRY CFG"),
        ("XRP/USDT", "LONG", "80.00", "0.5180", "0.5265", "+6.05", "+0.49%", "2%", "ENTRY CFG"),
    ]
...
.main {
  ...
  padding:6px 8px;
  display:grid;
  grid-template-rows:50px minmax(0, 1fr) 226px 50px;
  gap:6px;
  overflow:hidden;
}
...
/* Genel Bakış: referansın grafik-merkezli tek ekran kompozisyonu. */
.cards { display:none; }
.mid { grid-template-columns:1.62fr .78fr; }
.right-mid { grid-template-columns:1fr; grid-template-rows:1fr 1fr; }
...
/* Final Genel Bakış layout override: grafik merkezli, 1920x1080 tek ekran. */
.cards { display:none; }
.main { grid-template-rows:50px minmax(0,1fr) 226px 50px; }
.mid { grid-template-columns:1.62fr .78fr; }
.right-mid { grid-template-columns:1fr; grid-template-rows:1fr 1fr; }
.lower { grid-template-columns:1fr; }
...
"""
    ...
    open_positions = [row + (_action_button("KAPAT"),) for row in open_positions]
