...
BAD=re.compile(r'Ã|Â|â|Ä|Å|ï¿½|�')
M={
 'Ã‚Â·':'·','Ã‚':'','Ãƒâ€¡':'Ç','ÃƒÂ§':'ç','Ãƒâ€“':'Ö','ÃƒÂ¶':'ö','ÃƒÅ“':'Ü','ÃƒÂ¼':'ü','Ã„Â°':'İ','Ã„Â±':'ı','Ã…Å¾':'Ş','Ã…Å¸':'ş','Ã„Å¾':'Ğ','Ã„Å¸':'ğ',
 'Ã¢â‚¬â€œ':'–','Ã¢â‚¬â€':'—','Ã¢â‚¬â„¢':'’','Ã¢â‚¬Å“':'“','Ã¢â‚¬Â':'”','Ã¯Â¿Â½':'�',
 'Ã¶':'ö','Ã¼':'ü','Ã–':'Ö','Ãœ':'Ü','Ã‡':'Ç','Ã§':'ç','Ä°':'İ','Ä±':'ı','Åž':'Ş','ÅŸ':'ş','Äž':'Ğ','ÄŸ':'ğ','Â·':'·',
 'Ã„':'Ä','Ã…':'Å','Ã‚':'','Â':'','Ã':'','â€“':'–','â€”':'—','â€™':'’','â€œ':'“','â€':'”',
 'Å\x9e':'Ş','Å\x9f':'ş','Ä\x9e':'Ğ','Ä\x9f':'ğ','Ä\xb0':'İ','Ä\xb1':'ı','Å\xb0':'Ş','Å\xb1':'ş',
 'Ã\x96':'Ö','Ã\x9c':'Ü','Ã\xa7':'ç','Ã\xb6':'ö','Ã\xbc':'ü','Ã\x87':'Ç'
}
def clean(s):
    for _ in range(3):
        old=s
